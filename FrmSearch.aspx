<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmSearch.aspx.cs" Inherits="BUGHOUND.FrmSearch" %>
...
<body>
    ...
    <td><asp:DropDownList ID="ddlbugid" runat="server" Height="26px" Width="154px" 
    ...
    <td>
        <asp:Button ID="btnupdate" runat="server" Text="Update" BackColor="#00CC66" Height="31px" style="font-weight: 700" Width="80px" />
        </td>
    </tr>
    </table>
    </div>
