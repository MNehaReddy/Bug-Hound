<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADDNEWBUGDetails.aspx.cs" Inherits="BUGHOUND.ADDNEWBUGDetails" %>
...
<body>
    ...
    <td><asp:TextBox ID="txtassignTo" runat="server" Height="26px" Width="154px"></asp:TextBox></td>
         ...
         <div  style="margin-left:80%">
                        <table><tr><td> <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/AdminForm.aspx" ForeColor="Black" style="font-weight: 700">Back</asp:HyperLink></td>
