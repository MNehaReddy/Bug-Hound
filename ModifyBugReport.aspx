<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyBugReport.aspx.cs"
    Inherits="BUGHOUND.ModifyBugReport" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <br /><div style="background-color:#808080">  
                <br/><div align="center">
            ...
            <%--<asp:Image ID="img1" runat="server" ImageUrl="~/Images/bug hound.jpg" Height="200px"
                Width="100%" />
        </div>--%>
        ...
        <div align="center" style="color: #00FFFF; font-family: &quot;Times New Roman&quot;, Times, serif">
            ...
            <table style="font-family: 'Times New Roman', Times, serif; color: #000000">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtprogram" runat="server" Height="26px" Width="154px" OnTextChanged="txtprogram_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Report Type
                    ...
                    <td>
                        <asp:DropDownList ID="ddlRpttype" runat="server" Height="26px" Width="156px" OnSelectedIndexChanged="ddlRpttype_SelectedIndexChanged">
     ...
     <Columns>
        ...
        <div>
            ...
            <div  style="margin-left:80%">
                        <table><tr><td>  <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminForm.aspx" ForeColor="Black" style="font-weight: 700">Back</asp:HyperLink></td>
                            <td><asp:Button ID="btnback" runat="server" Text="Cancel" OnClick="btnback_Click" BackColor="#00CC66" Height="33px" Style="font-weight: 700" Width="75px" /></td></tr></table>
